...
Usage:
    ...
    FHIR_BEARER_TOKEN=your_token locust --host=http://localhost:4080 --locustfile=pagination.py
...
class PaginationUser(HttpUser):
    ...
    def on_start(self):
        ...
        response = self.client.get("/CarePlan?_count=10", headers=self.headers, name="/CarePlan?_count=10")
